...
# Predefined city coordinates for quick lookup (performance cache)
# Note: Any city NOT in this list will automatically be resolved 
# via the OpenWeatherMap Geocoding API, supporting millions of global locations.
CITY_COORDS = {
    # USA
